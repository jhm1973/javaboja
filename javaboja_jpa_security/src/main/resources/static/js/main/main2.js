                     ...
                     if(total_page>1){      
                        ...
                        $.each(result_data,function(key,value){
                           ...
                           result_text=result_text+"<div class='divTableBody'>"+
                                    ...
                                    "<a href='#' onclick='placeDetail("+value.id+");'>"+value.place_name+"</a>"+
                                    "</div>"+
                                    "</div>"+
                                    "</div>";      
                        });
      ...
      ajax_get_history = function(curPage){
         ...
         $.get("/main/history",
            ...
            function(data,status){
               ...
               for(var i=startPage;i<=endPage;i++){
                  if(i==curPage){
                     page_text = page_text+'<li class="active pageNumber"><a href="#" onclick="ajax_get_history('+i+');">'+i+'</a></li>'
                  }else{
                     page_text = page_text+'<li class="pageNumber"><a href="#" onclick="ajax_get_history('+i+');">'+i+'</a></li>'
                  }
